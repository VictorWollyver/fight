...
const Button = ({ theme, children, ...rest }: ButtonProps) => {
	const variantes = {
		...
		yellow: "text-yellow border-yellow hover:bg-yellow hover:border-strokeYellow hover:shadow-lightShadow hover:shadow-shadowYellow",
		green: "text-green border-green hover:bg-green hover:border-strokeGreen hover:shadow-lightShadow hover:shadow-shadowGreen",
	};
